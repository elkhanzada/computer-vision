function [reconstructed_image,best_ncc_1,best_ncc_2,x1,y1,x2,y2] = bonus_task(image_path)
    ...
    [best_ncc_1,x1,y1] = pyramid(red_channel,blue_channel,3);
    [best_ncc_2,x2,y2] = pyramid(red_channel,green_channel,3);
    blue_channel = circshift(blue_channel,[x1,y1]);
    green_channel = circshift(green_channel,[x2,y2]);
